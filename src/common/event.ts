...
import { combinedDisposable, Disposable, DisposableMap, DisposableStore, IDisposable, toDisposable } from 'common/lifecycle';
import { LinkedList } from 'common/linkedList';
import { IObservable, IObserver } from 'common/observable';
...
export namespace Event {
	...
	export function fromObservable<T>(obs: IObservable<T, any>, store?: DisposableStore): Event<T> {
		const observer = new EmitterObserver<T>(obs, store);
