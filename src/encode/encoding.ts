...
import { Readable, ReadableStream, newWriteableStream, listenStream } from 'common/stream';
import { VSBuffer, VSBufferReadable, VSBufferReadableStream } from 'common/buffer';
...
async function guessEncodingByBuffer(buffer: VSBuffer): Promise<string | null> {
	...
	// https://github.com/aadsm/jschardet/blob/v2.1.1/index.js#L36-L40
